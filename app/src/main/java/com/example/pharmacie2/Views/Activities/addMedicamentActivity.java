...
public class addMedicamentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveMedButton.setOnClickListener(v -> {
            if (validateInputs()) {
                // Proceed with saving the medicament
    ...
    private boolean validateInputs() {
        return validateEditText(editTextName, "Name") &&
                validateEditText(editTextDesc, "Description") &&
                validateEditText(editTextFab, "Fabricant") &&
                validateDoubleInput(editTextPrix, "Prix") &&
                validateIntegerInput(editTextQt, "Quantite en Stock");
    }
